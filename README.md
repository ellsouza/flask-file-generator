...
Aplicação web simples desenvolvida com **Python + Flask** para gerar arquivos `.txt` e `.pdf` a partir de um texto inserido pelo usuário.

Link do projeto (GitHub Pages):
https://ellsouza.github.io/flask-file-generator/
...
- Flask
- HTML e CSS
- ReportLab (para geração de PDF na versão Flask)
...
Obs.: o `index.html` é uma versão estática para visualização no navegador/GitHub Pages.
